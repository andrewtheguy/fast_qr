...
mod generators {
    ...
    fn generator1() {
        ...
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::L);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[7]);

        let version = crate::version::Version::V01;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::M);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[10]);

        let version = crate::version::Version::V01;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::Q);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[13]);

        let version = crate::version::Version::V01;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::H);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[17]);
    }
    ...
    fn generator2() {
        ...
        assert_eq!(generator, GENERATOR_POLYNOMIALS[16]);

        let version = crate::version::Version::V02;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::Q);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[22]);

        let version = crate::version::Version::V02;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::H);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[28]);
    }
    ...
    fn generator3() {
        ...
        assert_eq!(generator, GENERATOR_POLYNOMIALS[15]);

        let version = crate::version::Version::V03;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::M);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[26]);

        let version = crate::version::Version::V03;
        let generator = crate::hardcode::get_polynomial(version, crate::ecl::ECL::Q);

        assert_eq!(generator, GENERATOR_POLYNOMIALS[18]);
    ...
    fn generator4() {
        ...
        assert_eq!(generator, GENERATOR_POLYNOMIALS[20]);
    ...
    fn generator5() {
        ...
        assert_eq!(generator, GENERATOR_POLYNOMIALS[24]);
    ...
    fn generator9() {
        ...
        assert_eq!(generator, GENERATOR_POLYNOMIALS[30]);
